...
namespace BOOLEANDATA2.Controllers
{
    ...
    public class AcudientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAcudiente,Dni,TipoDocumento,Nombres,Apellidos,FechaNacimiento,Parentesco,Ocupacion,Clave,Usuario,Rol")] Acudiente acudiente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAcudiente,Dni,TipoDocumento,Nombres,Apellidos,FechaNacimiento,Parentesco,Ocupacion,Clave,Usuario,Rol")] Acudiente acudiente)
        {
