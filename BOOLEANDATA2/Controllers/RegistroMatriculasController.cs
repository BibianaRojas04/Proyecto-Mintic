...
namespace BOOLEANDATA2.Controllers
{
    public class RegistroMatriculasController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdPersonaAdmi1"] = new SelectList(_context.PersonalAdmins, "IdPerAdm", "IdPerAdm");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMatricula,FechaMatricula,ValorMatricula,IdEstudiante1,IdAcudiente1,IdPersonaAdmi1,Curso")] RegistroMatricula registroMatricula)
        {
            ...
            ViewData["IdPersonaAdmi1"] = new SelectList(_context.PersonalAdmins, "IdPerAdm", "IdPerAdm", registroMatricula.IdPersonaAdmi1);
            return View(registroMatricula);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMatricula,FechaMatricula,ValorMatricula,IdEstudiante1,IdAcudiente1,IdPersonaAdmi1,Curso")] RegistroMatricula registroMatricula)
        {
            if (id != registroMatricula.IdMatricula)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!RegistroMatriculaExists(registroMatricula.IdMatricula))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return _context.RegistroMatriculas.Any(e => e.IdMatricula == id);
        }
    }
}
